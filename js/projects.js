...
const PROJECTS = [
...

  {
    ...
    tools:       "Houdini · Nuke",
    tags:        ["TV", "Destruction", ""],
    description: "Senior FX TD across three episodes of Apple TV+'s MonsterVerse series. Large-scale destruction,  impact, and environmental devastation work — bringing the weight and chaos of kaiju-scale events to the small screen with feature-film fidelity.",
    vimeo:       "",
    youtube:     "JLHsM4bpfxY",
...

  {
    ...
    tools:       "Houdini · Nuke",
    tags:        ["Film", "Sci-Fi", ""],
    description: "Digital Artist at MPC on Ridley Scott's continuation of the Alien saga. Atmospheric environment and -driven effects work across the film's most visceral sequences.",
    vimeo:       "",
    youtube:     "svnAD0TApb8",
