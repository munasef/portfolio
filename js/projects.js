...
const PROJECTS = [
...

  {
    ...
    featured:    true,
    tags:        ["Games"],
    description: "Leading VFX for the open-world fantasy reboot at Eidos-Montréal for Xbox. Responsible for establishing and owning the full FX pipeline end-to-end — defining workflows between Houdini simulation, Niagara authoring, and Unreal Engine 5 delivery. The core challenge is achieving offline-quality organic and magical effects within engine budget, across a large open world with varied biomes and scripted set pieces.",
    youtube:     "w6TJTHdgmts",
