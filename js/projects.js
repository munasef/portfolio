...
const PROJECTS = [
...

  {
    ...
    featured:    true,
    tags:        ["Games"],
    description: "Lead of the cinematics VFX team at Eidos-Montréal for Xbox's Fable reboot. Built the FX pipeline — custom Houdini import/export workflow into ForzaTech. Led hero destruction work while supervising a team of two.",
    youtube:     "w6TJTHdgmts",
...

  {
    ...
    tags:        ["TV"],
    description: "Senior FX TD at Weta FX on one episode of HBO's adaptation. RBD and volumetric work on a zombie emergence sequence.",
    vimeo:       "",
    youtube:     "uLtkt8BonwM",
...

  {
    ...
    tools:       "Houdini · Nuke",
    tags:        ["Film", "Destruction", "Pyro"],
    description: "Lead FX TD at DNEG, heading the Montréal team on one of the highest-grossing Chinese films of all time. Ocean and ship interactions, explosions, and RBD on large-scale battlefield sequences.",
    vimeo:       "",
    youtube:     "gbCUoKya2_U",
...

  {
    ...
    awards:      ["Academy Award — Best Visual Effects", "BAFTA — Best Special Visual Effects"],
    tags:        ["Film", "Destruction"],
    description: "Lead FX TD at DNEG on Denis Villeneuve's adaptation. Led teams of up to 13 artists — lookdev, cross-site setup and support, hero shots in Houdini.",
    vimeo:       "",
    youtube:     "8g18jFHCLXk",
...

  {
    ...
    tools:       "Houdini",
    tags:        ["Film"],
    description: "FX Artist at Cinesite on the animated feature.",
    vimeo:       "",
    youtube:     "4A8X8qd2cRI",
...

  {
    ...
    tools:       "Houdini",
    tags:        ["Film"],
    description: "FX Artist at Cinesite on the animated family film.",
    vimeo:       "",
    youtube:     "WPxoOTZIuAQ",
...

  {
    ...
    tools:       "Houdini · Nuke",
    tags:        ["Film", "Fluids"],
    description: "FX TD at DNEG on Disney+'s survival drama. Snow, ice, and blizzard simulation.",
    vimeo:       "",
    youtube:     "HMfyueM-ZBQ",
...

  {
    ...
    tools:       "Houdini",
    tags:        ["Film"],
    description: "FX Artist at Cinesite on the animated Addams Family reboot. Stylised effects work.",
    vimeo:       "",
    youtube:     "xFCrR3Uw6Mk",
...

  {
    ...
    tools:       "Houdini · Nuke",
    tags:        ["Film"],
    description: "FX Artist at MPC on Jumanji: Welcome to the Jungle. Environmental and jungle FX.",
    vimeo:       "",
    youtube:     "2QKg5SZ_35I",
