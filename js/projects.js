...
const PROJECTS = [
...

  {
    ...
    description: "Most recent shipped games project. Led real-time VFX on cinematics for the latest Tomb Raider entry, owning the full effects pipeline from simulation through in-engine delivery.",
    vimeo:       "",
    youtube:     "jZj4vWjzGas",
...

  {
    ...
    featured:    true,
    tags:        ["Games"],
    description: "Currently leading real-time VFX for the highly anticipated open-world fantasy reboot developed at Eidos-Montréal for Xbox. Responsible for the full FX pipeline — from concept and simulation through in-engine delivery — bringing a living, magical world to life in real time.",
    vimeo:       "",
    youtube:     "w6TJTHdgmts",
...

  {
    ...
    description: "Led the FX team at DNEG on Eli Roth's live-action adaptation of the iconic video game franchise. The work demanded bridging the game's distinctive cel-shaded visual language with cinematic-scale simulation — explosions, elemental abilities, and environment destruction grounded in a stylised world.",
    vimeo:       "",
    youtube:     "lU_NKNZljoQ",
...

  {
    ...
    tags:        ["Film", "Destruction", "Creature"],
    description: "Senior FX TD on Weta FX's work for Wes Ball's continuation of the franchise. Simulation work spanned water, destruction, and large-scale environment FX, integrated alongside Weta's photoreal digital apes across 1,500+ VFX shots.",
    vimeo:       "",
    youtube:     "XtFI7SNtVpY",
...

  {
    ...
    studio:      "Weta FX",
    tools:       "Houdini · Nuke",
    tags:        ["TV", "Destruction", "Creature"],
    description: "Senior FX TD across three episodes of Apple TV+'s MonsterVerse series. Large-scale destruction, creature impact, and environmental devastation work — bringing the weight and chaos of kaiju-scale events to the small screen with feature-film fidelity.",
    vimeo:       "",
    youtube:     "JLHsM4bpfxY",
...

  {
    ...
    description: "FX TD at Weta FX on the seventh instalment of the Transformers franchise. Large-scale destruction, terrain deformation, and mechanical debris simulations supporting the film's massive robot-scale action sequences.",
    vimeo:       "",
    youtube:     "itnqEauWQZM",
...

  {
    ...
    tools:       "Houdini · Nuke",
    tags:        ["TV"],
    description: "FX TD at Weta FX on one episode of HBO's critically acclaimed adaptation. Contributed to the naturalistic, grounded effects work that gave the show its documentary-like visual authenticity — restraint and believability over spectacle.",
    vimeo:       "",
    youtube:     "uLtkt8BonwM",
...

  {
    ...
    tools:       "Houdini · Nuke",
    tags:        ["Film", "Destruction", "Pyro"],
    description: "Lead Digital Artist at DNEG on David Leitch's fast-paced action thriller. Destruction, glass breakage, and explosion simulations across relentless action sequences, balancing physical plausibility with the film's heightened visual style.",
    vimeo:       "",
    youtube:     "0IOsk2Vlc4o",
...

  {
    ...
    tools:       "Houdini · Nuke",
    tags:        ["TV", "Sci-Fi"],
    description: "Lead FX TD at DNEG on one episode of Apple TV+'s epic adaptation of Isaac Asimov's landmark sci-fi series. Grand-scale environmental and civilisation-level FX work befitting one of the most ambitious space operas ever produced for television.",
    vimeo:       "",
    youtube:     "X4QYV5GTz7c",
...

  {
    ...
    tools:       "Houdini · Nuke",
    tags:        ["Film", "Destruction", "Pyro"],
    description: "Lead FX TD at DNEG on one of the highest-grossing Chinese films of all time. Extensive battlefield destruction, pyrotechnic enhancement, and large-scale environment simulation across one of cinema's most logistically demanding war productions.",
    vimeo:       "",
    youtube:     "gbCUoKya2_U",
...

  {
    ...
    description: "Lead FX TD at DNEG on Denis Villeneuve's Oscar-winning adaptation, contributing to nearly 1,200 VFX shots. Sand, dust, and atmospheric simulations defining the austere, tactile feel of Arrakis — the film won the Academy Award for Best Visual Effects.",
    vimeo:       "",
    youtube:     "8g18jFHCLXk",
...

  {
    ...
    tools:       "Houdini · Nuke",
    tags:        ["Film", "Sci-Fi"],
    description: "Lead FX TD at DNEG London on Antoine Fuqua's sci-fi action thriller. High-energy FX across kinetic action sequences, including vehicle destruction and large-scale environmental effects.",
    vimeo:       "",
    youtube:     "4q-6epHUKcE",
